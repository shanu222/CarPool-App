...
export function Layout() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-x-hidden">
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 z-50 mx-auto w-full max-w-[420px] px-3 pb-3 pointer-events-auto">
        <div className="glass-panel rounded-2xl px-2 py-2 md:px-3 md:py-3">
          <div className="flex items-center justify-around gap-1 pointer-events-auto">
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`min-h-12 flex flex-1 flex-col items-center justify-center gap-1 rounded-xl px-2 py-1 text-xs transition-all duration-200 pointer-events-auto ${
                  isActive
